...
game.party = pokemon[5]

//--------------------------------------------------------------------------------------------------

/*
const firstPokemon = pokemon[8];
const secondPokemon = pokemon[65];
const thirdPokemon = pokemon[127]; 

game.party.push(firstPokemon, secondPokemon, thirdPokemon)
